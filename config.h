...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_Escape,	spawn,	SHCMD("prompt \"Leave Xorg?\" \"pkill -x Xorg\"") },
	...
	{ MODKEY,			XK_a,		spawn,		SHCMD("st -e htop") },
	{ MODKEY|ShiftMask,		XK_a,		spawn,		SHCMD("st -e lmc control") },
	...
	{ 0, XF86XK_Sleep,		spawn,		SHCMD("prompt \"Suspend computer?\" \"sudo zzz\"") },
...
static Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button1,        spawn,          SHCMD("st -e less .local/share/larbs/dwmblocksinfo") },
